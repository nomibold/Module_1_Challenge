...
print("The total value of the loans is", total_of_loans)
...
if present_value >= total_of_loans:
    print("This loan is worth at least the cost to buy it!")
elif present_value < total_of_loans:
    print("The loan is too expensive and not worth the price!")

#If present value represents the loan's fair value, it would still be worth at least the cost to buy it.
